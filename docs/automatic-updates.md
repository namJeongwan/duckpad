...
- Eleven presentation tests passed: badge lifecycle/click routing, Korean text, shared update actions, About status completion/cancellation, Escape/reopening and existing menu behavior. Six targeted termination tests passed, including cancellation/failure and unsaved recovery.
...
- The compact About window was visually checked in Korean in the packaged app, including Escape close/reopen. All eight languages contain the five new strings; the other seven localized layouts were not visually checked.
