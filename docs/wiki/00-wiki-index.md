...
| 72 | [Phase 29B parity gap assessment and extension shortcuts](35-parity-gap-assessment.md) | **Implementation assessment in progress** | 94개 feature를 보수적으로 전수 분류하고 manifest 단축키를 native menu에 실제 연결하되 core 충돌·잘못된 선언은 접근 가능한 진단과 함께 fail closed 처리한다. |
