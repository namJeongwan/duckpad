...
@Test func legacyPreferencesMigrateAndAllNewControlsSurviveRelaunch() async throws {
    ...
    let updated = AppSettings(appearanceMode: .light, editorFontName: "Monaco", editorFontSize: 18.25, editorLeftPadding: 3, editorRightPadding: 12, editorLineSpacing: 7, liveFileReloadEnabled: false, menuBarVisible: false, statusBarVisible: false,
