...
@Test func legacyPreferencesMigrateAndAllNewControlsSurviveRelaunch() async throws {
    ...
    let updated = AppSettings(appearanceMode: .light, editorFontName: "Monaco", editorFontSize: 18.25, liveFileReloadEnabled: false, menuBarVisible: false, statusBarVisible: false,
